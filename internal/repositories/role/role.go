...
// RemovePermissions removes specific permissions from a role
...
// AssignMenus assigns multiple menus to a role
...
// RemoveMenus removes specific menus from a role
...
// GetRoleMenus retrieves all menu IDs for a role
