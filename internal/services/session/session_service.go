...
// ValidateSession validates if a session is still active and valid
...
// DestroySessionByToken destroys a session by token
...
// DestroyOtherSessions destroys all sessions except the current one
