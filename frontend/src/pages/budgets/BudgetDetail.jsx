    ...
    <>
      ...
      {isFinalized && canOverrideFinalized && (
        <div className="alert alert-info mb-4" role="alert">
          ...
          <strong>Override Access:</strong> This budget has status "{budget.status}" (finalized), but you can still modify it because you have finalized override permission.
        </div>
      )}
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <div className="d-flex gap-2">
          {hasPermission('update_budgets') && !(isFinalized && !canOverrideFinalized) && (
            <Link to={`/budgets/${id}/edit`} className="btn btn-warning">
              <i className="bi bi-pencil me-2"></i>Edit
            </Link>
          )}
          {hasPermission('delete_budgets') && !(isFinalized && !canOverrideFinalized) && (
