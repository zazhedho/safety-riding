...
INSERT INTO menu_items (id, name, display_name, path, icon, order_index) VALUES
    ...
    (gen_random_uuid(), 'education_stats', 'Education Stats', '/schools/education-stats', 'bi-bar-chart', 1),
    (gen_random_uuid(), 'education_priority', 'Education Priority', '/schools/education-priority', 'bi-grid-3x3-gap', 2),
