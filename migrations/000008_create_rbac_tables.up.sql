...
INSERT INTO menu_items (id, name, display_name, path, icon, order_index) VALUES
    ...
    (gen_random_uuid(), 'education_stats', 'Education Stats', '/education/stats', 'bi-bar-chart', 1),
    (gen_random_uuid(), 'education_priority', 'Education Priority', '/education/priority', 'bi-grid-3x3-gap', 2),
    ...
    (gen_random_uuid(), 'education', 'Education', '', 'bi-mortarboard', 7),
...
INSERT INTO permissions (id, name, display_name, resource, action) VALUES
    ...
    (gen_random_uuid(), 'view_education_priority', 'View Education Priority', 'education_priority', 'view'),
    ...
    -- Menu permissions
    (gen_random_uuid(), 'view_menus', 'View Menus', 'menus', 'view'),
    (gen_random_uuid(), 'create_menus', 'Create Menus', 'menus', 'create'),
    (gen_random_uuid(), 'update_menus', 'Update Menus', 'menus', 'update'),
    (gen_random_uuid(), 'delete_menus', 'Delete Menus', 'menus', 'delete'),
